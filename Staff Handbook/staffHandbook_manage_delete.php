...
if (isActionAccessible($guid, $connection2, "/modules/Staff Handbook/staffHandbook_manage_delete.php")==FALSE) {
	...
	if ($staffHandbookEntryID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/Staff Handbook/staffHandbook_manage_deleteProcess.php?staffHandbookEntryID=$staffHandbookEntryID&search=" . $_GET["search"] ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete "<?php print $row["title"] ?>" from Staff Handbook?</b><br/>
					...
					<tr>
						<td> 
							<input name="staffHandbookEntryID" id="staffHandbookEntryID" value="<?php print $staffHandbookEntryID ?>" type="hidden">
